...
from mcp_pal.domain.validation import validate_mcp_config
from mcp_pal.harness.manifest import HarnessManifest
...
class RunCreate(BaseModel):
    ...
    enabled_server: str
    tool_mode: Literal["mcp_only", "mcp_read_only", "full", "agent_default"] = (
        "mcp_only"
    )
...
class RunClone(BaseModel):
    ...
    tool_mode: Literal["mcp_only", "mcp_read_only", "full", "agent_default"] | None = (
        None
    )
    harness_revision_id: str | None = None
    agent_mode_id: str | None = None
