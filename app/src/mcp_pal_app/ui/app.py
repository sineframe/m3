...
from mcp_pal_app.ui.trace_view import actor, display_name, format_duration, number, preview_value, server_latency_for, visible_spans, wire_unavailable_message
...
def truncate(value, limit=MAX_PREVIEW):
    ...
    text=projected if isinstance(projected,str) else json.dumps(projected, ensure_ascii=False, indent=2)
