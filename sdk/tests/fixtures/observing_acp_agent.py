"""Test-only ACP fixture wrapper that records inbound lifecycle messages.

The wrapped implementation remains the package-owned ACP fixture agent, so
this fixture observes the black-box protocol without adding test hooks to it.
"""
...
from m3.fixtures import acp_agent
...
def main(argv: list[str] | None = None) -> int:
    ...
    return acp_agent.main(arguments)
