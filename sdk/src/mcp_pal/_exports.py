...
PUBLIC_EXPORTS: dict[str, tuple[str, ...]] = {
    "mcp_pal": (
        ...
        "ConnectionId", "ContentBlock", "DirectExecutionSpec", "DirectOperation", "DirectOperationBase", "DirectOperationResultBase", "DirectTool", "DirectResource", "DirectResourceTemplate", "DirectPrompt", "ErrorCode", "ErrorInfo", "EvaluationContext",
