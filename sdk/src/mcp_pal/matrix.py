...
_MATRIX_METADATA_PREFIX = "mcp_pal.matrix."
...
def _pytest_parametrize(
    ...
    try:
        ...
        raise ImportError(
            ...
            "install it with mcp-pal[pytest]"
        ) from exc
...
class ToolMatrixCase(_FrozenModel):
    ...
    def _metadata(
        ...
        values: dict[str, _Scalar] = {
            "mcp_pal.matrix.case_id": self.id,
            "mcp_pal.matrix.kind": "tool",
...
class HarnessMatrixCase(_FrozenModel):
    ...
    def _metadata(
        ...
        values: dict[str, _Scalar] = {
            "mcp_pal.matrix.case_id": self.id,
            "mcp_pal.matrix.kind": "harness",
            "mcp_pal.matrix.mode": self.mode,
