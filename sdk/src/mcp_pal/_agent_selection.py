        ...
        **options: _Any,
        ...
        if self.model is None:
            ...
            for key, value in {
                ...
                "trial": self.trial,
                "mcp_pal.matrix.harness": "profile",
                "mcp_pal.matrix.trial": self.trial,
                "mcp_pal.matrix.matrix_id": self.entry.get("_matrix_id"),
                "mcp_pal.matrix.cell_id": self.entry.get("_cell_id"),
            }.items():
                if key in metadata:
