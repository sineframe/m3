...
Examples::
    ...
    python -m m3.harness.cli validate harness.json --check-local
    python -m m3.harness.cli probe harness.json --kind protocol
    python -m m3.harness.cli probe harness.json --kind full --mode-id default
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m m3.harness.cli")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"python -m m3.harness.cli: {exc}", file=sys.stderr)
        return 2
