"""Private execution-bound recording for M3 matcher checks."""
...
_DEFAULT = ContextVar("m3_record_checks_default", default=False)
_SUPPRESSED = ContextVar("m3_record_checks_suppressed", default=0)
...
def _record_issue(code: str) -> None:
    try:
        ...
        values = diagnostics.setdefault("m3", [])
