...
from ..persistence.models import McpProfile, McpProfileRevision, Run, RunEvent, RunTrace, RunHarnessSnapshot, HarnessProfile, HarnessProfileRevision, HarnessProbe, now, uid
...
from ..harness.manifest import validate_manifest, ManifestValidationError
...
def create_app(settings: Settings | None = None, engine_override=None, session_factory=None) -> FastAPI:
    ...
    def probe_harness(profile_id:str, kind:str="protocol", transport:str="stdio", mode_id:str|None=None, session_config:str="{}", d:Session=Depends(db_dep)):
        ...
        def execute_probe():
            ...
            import asyncio
            from ..harness.acp import AcpHarnessRunner, protocol_probe, full_probe
            try:
